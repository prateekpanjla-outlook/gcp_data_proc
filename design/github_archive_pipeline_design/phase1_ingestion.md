# Phase 1: Ingestion - Detailed Specification
...
```
Current Time: 2025-01-15 14:35 UTC
Target File: 2025-01-15-14.json.gz

GitHub Archive typically makes files available within 1 hour of the hour.
If file is not available yet, the job should retry with backoff.
```
