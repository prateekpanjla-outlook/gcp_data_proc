...
# ==============================================================================
# Dashboard - Commented out for v7.0 compatibility
# The dashboard resource structure has changed significantly in v7.0
# ==============================================================================
# resource "google_monitoring_dashboard" "pipeline_dashboard" {
#   # This resource needs to be recreated with the new JSON-based format
#   # For now, we'll skip it to get the basic infrastructure working
# }
